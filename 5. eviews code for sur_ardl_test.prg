...
equation eq1.ls d(y1) d(x11) c @trend y1(-1) x11(-1)
equation eq2.ls d(y1) d(x11) c
...
scalar ff_num=(ssr12-ssr11)/(5-2)
scalar ff_den=ssr11/(45-5-1)
scalar ff1=ff_num/ff_den
mout(1,1)=ff1
scalar ssr21=ss1.@ssr(2)
scalar ssr22=ss2.@ssr(2)
scalar ff_num=(ssr22-ssr21)/(5-2)
scalar ff_den=ssr21/(45-5-1)
scalar ff2=ff_num/ff_den
mout(1,2)=ff2
scalar ssr31=ss1.@ssr(3)
scalar ssr32=ss2.@ssr(3)
scalar ff_num=(ssr32-ssr31)/(5-2)
scalar ff_den=ssr31/(45-5-1)
scalar ff3=ff_num/ff_den
mout(1,3)=ff3
scalar ssr41=ss1.@ssr(4)
scalar ssr42=ss2.@ssr(4)
scalar ff_num=(ssr42-ssr41)/(5-2)
scalar ff_den=ssr41/(45-5-1)
scalar ff4=ff_num/ff_den
mout(1,4)=ff4
scalar ssr51=ss1.@ssr(5)
scalar ssr52=ss2.@ssr(5)
scalar ff_num=(ssr52-ssr51)/(5-2)
scalar ff_den=ssr51/(45-5-1)
